  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-3 w-11 h-11 bg-gray-800/10 backdrop-blur-sm rounded-xl flex items-center justify-center z-50 shadow-lg md:hidden border border-gray-700"
      >
